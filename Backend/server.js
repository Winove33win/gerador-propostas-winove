...
const start = async () => {
  ...
  if (!isDbConfigured) {
    ...
    try {
      ...
      console.error('[WARN] Falha ao conectar no banco:', error?.message || error);
      console.warn('[WARN] Continuando sem banco de dados. Algumas funcionalidades podem não funcionar.');
    }
  }
